...
class Activity implements ArrayAccess
{
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['points_rate'] = isset($data['points_rate']) ? $data['points_rate'] : null;
    ...
    {
        return $this->container['points_rate'];
    }

    /**
     * Sets points_rate
     * @param float $points_rate
     * @return $this
     */
    public function setPointsRate($points_rate)
    {
        $this->container['points_rate'] = $points_rate;
